#!/bin/bash
#
# Umbrella Systems — Desktop Support Shortcut Uninstaller (App Version)
# Removes the "Submit a Ticket" app shortcut from all users' desktops.
...
for USER_HOME in /Users/*/; do
    ...
    rm -rf "${USER_HOME}Desktop/${APP_NAME}"
done
